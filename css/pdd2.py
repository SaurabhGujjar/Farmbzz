...
import numpy as np
directory_name = "/home/saurav/Desktop/plantdisease/PlantVillage/potato"
...
for image_name in image_names:
    foo = cv2.imread("/home/saurav/Desktop/plantdisease/PlantVillage/potato/" + image_name)
...
def findSimilarImage(X):
    image_name = X #Image to be used as query
    ...
    print("HAHA")
    img.save(fp='static-serve/static_root/img/my21.jpg')
    img.show()
